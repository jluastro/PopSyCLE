...
def run():
    ...
    optional.add_argument('--seed', type=int,
                          ...
                          default=None)
    optional.add_argument('--overwrite', type=bool,
    ...
    check_for_output(filename_dict['ebf_filename'], args.overwrite)
    ...
    check_for_output(filename_dict['events_filename'], args.overwrite)
    check_for_output(filename_dict['blends_filename'], args.overwrite)
    ...
    check_for_output(filename, args.overwrite)
